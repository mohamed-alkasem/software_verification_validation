...
{
    public class HrKategorilerForKitapAdminOffcanvasViewComponent :ViewComponent
    {
        private readonly IServiceProvider _serviceProvider;

        public HrKategorilerForKitapAdminOffcanvasViewComponent(IServiceProvider serviceProvider)
        {
