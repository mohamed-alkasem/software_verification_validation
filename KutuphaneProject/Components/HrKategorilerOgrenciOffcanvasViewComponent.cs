...
{
    public class HrKategorilerOgrenciOffcanvasViewComponent : ViewComponent
    {
        private readonly IServiceProvider _serviceProvider;

        public HrKategorilerOgrenciOffcanvasViewComponent(IServiceProvider serviceProvider)
        {
